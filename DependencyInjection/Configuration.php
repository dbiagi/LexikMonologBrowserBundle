        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('date_format')
                    ...
                    ->info('Date format to be used in the filter form. This format follows the php datetime description. See http://php.net/manual/en/datetime.createfromformat.php.')
                ->end()
                ->arrayNode('doctrine')
                    ->children()
